...
class ForceField(object):
    ...
    def __init__(self, ffield):
        ...
        if self.name == 'uffqm':
            ...
            self.set_ctrl_uffqm()
        elif self.name == 'morse_pqeq':
            self.set_ctrl_morse_pqeq()
        elif self.name == 'morse':
            self.set_ctrl_morse()
        elif self.name == 'lj/cut/coul/cut':
            self.set_ctrl_lj_cut_coul_cut ()
            ...
            self.set_ctrl_ljcut()
        elif self.name == 'rexpon_unb':
            self.set_ctrl_rexpon_unb()
    ...
    def set_ctrl_morse_pqeq(self):
        ''' Set the defaults for the control section assuming morse_pqeq. '''
    ...
    def set_ctrl_morse(self):
        ...
        self.ffield['CONTROL'] = {}
        self.ffield['CONTROL']['units'] = 'real'
        self.ffield['CONTROL']['atom_style'] = 'full'
        self.ffield['CONTROL']['boundary'] = 'f f f'
        self.ffield['CONTROL']['special_bonds'] = 'lj 1.0 1.0 1.0 coul 1.0 1.0 1.0'

    def set_ctrl_lj_cut_coul_cut(self):
        ''' Set the defaults for the control section assuming lj/cut/coul/cut. '''
    ...
    def set_ctrl_rexpon_unb(self):
        ''' Set the defaults for the control section assuming RexPoN UNB '''
